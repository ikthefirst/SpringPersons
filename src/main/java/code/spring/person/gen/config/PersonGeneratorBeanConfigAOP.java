...
import code.spring.person.gen.generator.aop.LoggingAspect;
...
// @ComponentScan(basePackages = { "code.spring.person.gen.generator.aop" })
public class PersonGeneratorBeanConfigAOP {
